...
function AppointmentComponents() {
    return (
        <Link href={''} className="flex items-center gap-2 p-3 px-4 rounded-md bg-gray-100 hover:bg-gray-50 dark:bg-gray-800/40 dark:hover:bg-gray-800 transition-all">
